...
export const Registro = () => {
	...
	return (
		<div>
			...
			<input value={email} onChange={event => setEmail(event.target.value)} name="email" id="email" type="text" />
			...
			<select id="services" name="services" value={services} onChange={event => setServices(event.target.value)}>
