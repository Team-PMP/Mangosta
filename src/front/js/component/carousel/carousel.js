	...
	return (
		<div ref={sliderRef} className="keen-slider">
			...
			<div className="keen-slider__slide number-slide4">
				<img src="https://m.media-amazon.com/images/I/61F8azhl1lL._AC_UY218_.jpg" />
			</div>
			<div className="keen-slider__slide number-slide5">
				<img src="https://m.media-amazon.com/images/I/71eSq8eWxhL._AC_UY218_.jpg" />
			</div>
			<div className="keen-slider__slide number-slide6">
				<img src="https://m.media-amazon.com/images/I/71KYip4oScS._AC_UY218_.jpg" />
			</div>
		</div>
	);
};
